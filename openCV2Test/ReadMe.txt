========================================================================
    KONSOLENANWENDUNG: openCV2Test-Projektübersicht
========================================================================

Diese openCV2Test-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre openCV2Test-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen openCV2Test.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
